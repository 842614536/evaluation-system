  ...
  <div class="wrap">
    <div class="left">
      <div class="block-shadow issue-block-title">
        ...
        <el-tag class="ml-default" size="small" type="danger">未提交</el-tag>
        <span style="margin-left: 460px"></span>
      ...
      <div class="mt20 block-shadow pd20">
        ...
        <el-tabs v-model="activeName">
          <el-tab-pane label="形式审查" name="first">
            <Table :columns="columns" :dataList="dataList" :isShowPagination="false"/>
          </el-tab-pane>
          <el-tab-pane label="专家评审" name="second">
            <Table :columns="columns2" :dataList="dataList" :isShowPagination="false"/>
          </el-tab-pane>
        </el-tabs>
        <br>
      </div>
