<template>
  <div>
    <div class="block-shadow pd20 tar">
      <el-form>
        <el-form-item label="自评打分表:" label-width="100px">
          <el-upload
            class="upload-demo"
            action=""
            multiple
            :file-list="[{name: '绿城大连深蓝中心.xlsx'}]"
            :limit="3">
            <el-button size="small" type="primary">上传文件<i class="el-icon-upload el-icon--right"></i></el-button>
            <el-button size="small" type="primary">自评估报告模板<i class="el-icon-download el-icon--right"></i></el-button>
            <div slot="tip" class="el-upload__tip">请上传自评打分表,支持扩展名：.xls .xlsx，大小不超过5M </div>
          </el-upload>
        </el-form-item>
      </el-form>
      <div class="mt20">
