    ...
    <el-collapse v-model="active">
      <el-collapse-item id="1" title="基本信息" name="1">
        <div style="padding-left: 60px">
          <Form labelWidth="250px" :queryItems="queryItems1"/>
        </div>
      ...
      <el-collapse-item id="2" title="关键评价指标" name="2">
        <div style="padding-left: 60px">
          <Form labelWidth="250px" :queryItems="queryItems2"/>
        </div>
      </el-collapse-item>
      <el-collapse-item id="3" title="增量成本" name="3">
        <div style="padding-left: 60px">
          <Form labelWidth="250px" :queryItems="queryItems3"/>
        </div>
        <div style="padding: 0 20px">
          <div class="mt20 block-shadow issue-block-title">
            <span></span>
        ...
        <div style="padding: 0 20px">
          <el-form label-width="150px">
            <el-form-item class="textarea-wrap" label="工程概括:">
              <el-input type="textarea" v-model="textarea.a"/>
            </el-form-item>
        ...
        <div style="padding: 0 20px">
          <el-form label-width="150px">
            <el-form-item class="textarea-wrap" label="安全耐久:">
              <el-input type="textarea" v-model="textarea.b"/>
            </el-form-item>
            <el-form-item class="textarea-wrap" label="健康舒适:">
              <el-input type="textarea" v-model="textarea.c"/>
            </el-form-item>
            <el-form-item class="textarea-wrap" label="生活便利:">
              <el-input type="textarea" v-model="textarea.d"/>
            </el-form-item>
            <el-form-item class="textarea-wrap" label="资源节约:">
              <el-input type="textarea" v-model="textarea.e"/>
            </el-form-item>
            <el-form-item class="textarea-wrap" label="环境宜居:">
              <el-input type="textarea" v-model="textarea.f"/>
            </el-form-item>
            <el-form-item class="textarea-wrap" label="提高与创新:">
              <el-input type="textarea" v-model="textarea.g"/>
            </el-form-item>
          </el-form>
        </div>
      </el-collapse-item>
        ...
        <div style="padding: 0 20px">
          <el-form label-width="150px">
            <el-form-item class="textarea-wrap" label="项目创新点:">
              <el-input type="textarea" v-model="textarea.h"/>
            </el-form-item>
            <el-form-item class="textarea-wrap" label="项目推广价值:">
              <el-input type="textarea" v-model="textarea.i"/>
            </el-form-item>
            <el-form-item class="textarea-wrap" label="综合效益分析:">
              <el-input type="textarea" v-model="textarea.j"/>
            </el-form-item>
          </el-form>
        </div>
      </el-collapse-item>
        ...
        <div style="padding: 0 20px">
          <el-form label-width="150px">
            <el-form-item class="textarea-wrap" label="申报单位概况:">
              <el-input type="textarea" v-model="textarea.k"/>
            </el-form-item>
            </el-form-item>
          </el-form>
        </div>
